...
public class Maceman implements Unit  {
    private String name;
    private int hp;
    private int maxHp;
    ...
    public Maceman() {
        ...
        Path path_image = Paths.get("Client", "Assets", "Images", "CrusaderUnits", "Maceman.png");
        Path path_sound = Paths.get("Client", "Assets", "Audios", "CrusaderUnits", "Maceman", "Mace_m3a.wav");
