...
public class Swordsman implements Unit  {
    ...
    public Swordsman() {
        ...
        Path path_image = Paths.get("Client", "Assets", "Images", "CrusaderUnits", "Swordsman.png");
        Path path_sound = Paths.get("Client", "Assets", "Audios", "CrusaderUnits", "Swordsman", "Sword_m3a.wav");
