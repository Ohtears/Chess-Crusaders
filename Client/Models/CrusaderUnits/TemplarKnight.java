...
public class TemplarKnight implements Unit {
    private String name;
    private int hp;
    private int maxHp;
    ...
    public TemplarKnight() {
        ...
        Path path_image = Paths.get("Client", "Assets", "Images", "CrusaderUnits", "TemplarKnight.png");
        Path path_sound = Paths.get("Client", "Assets", "Audios", "CrusaderUnits", "TemplarKnight", "Knight_s4a.wav");
