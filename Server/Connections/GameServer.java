...
public class GameServer {
    ...
    private static final Map<User, ClientHandler> clientHandlers = Collections.synchronizedMap(new HashMap<>());
                ...
                while ((requestPayloadString = in.readLine()) != null) {
                    ...
                    switch (request) {
                        ...
                        case JOINLOBBY:
                            ...
                            System.out.println("JOINLOBBY: " + this.out);
                            for (LobbyInstance lobby : lobbyInstances) {
                                ...
                                if (port == client.getport()) {
                                    ...
                                    if (creatorHandler != null) {
                                        System.out.println("Notifying creator handler: " + creatorHandler.out);
                        ...
                        case STARTGAME:
                            ...
                            for (LobbyInstance lobby : lobbyInstances) {
                                ...
                                if (port == client1.getport()) {
                                    ...
                                    System.out.println("Notifying participant: " + participant.out);
                                    Game game = new Game(0, 0, crusaderplayer, muslimplayer, 0, 0);
                                    games.add(game);

                                    synchronized (participant.lock) {
                                        participant.out.println("200");
                                        participant.lock.notify();
                                        System.out.println("Participant notified.");
                                    }
                                    out.println("200");
                                }
                            }
                        ...
                        case WAITGAME:
                            synchronized (lock) {
                                try {
                                    ...
                                    lock.wait();
                                    System.out.println("Game started, proceeding...");
                                } catch (InterruptedException e) {
                                    e.printStackTrace();
                                }
                            }
